 ...
 * Copy semua kode ini ke file Code.gs di Apps Script.
 */

// ID Google Sheet kamu. Jangan isi link full, cukup ID setelah /d/.
...
function ensureReady_() {
  if (!SPREADSHEET_ID || SPREADSHEET_ID.includes('/edit')) {
